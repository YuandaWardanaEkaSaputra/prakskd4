...
<html>
	<head>
		<title>Yuanda - Vigenere Cipher</title>
	...
	<body>
		...
		<form action="index.php" method="post">
			<table cellpadding="5" align="center" cellpadding="2" border="7">
				<caption><hr><b>Praktikum SKD - Text Cryption</b><hr></caption>
				<tr>
				...
				<tr>
					<td align="center">Praktikum SKD | By: Yaunda | Nim : V3920062  <span style="cursor:pointer;color:#0000FF" onclick="help()"></span></td>
				</tr>
				<tr>
